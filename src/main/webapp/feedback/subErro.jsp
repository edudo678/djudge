                        ...
                        <div class="card px-4 py-4 text-black">
                            ...
                            <div class="row justify-content-center px-4">
                                <div class="col-md-4 align-content-end">
                                    <img src="../img/erro.gif" width="100%" height="100%">
                                </div>
                                <div class="row">
                                    <div class="align-self-center">
                                        <div class="col-md-12">    
                                            <h4>Erro: saída inválida</h4>  
                                            <h5>Verifique seu código e tente novamente</h5>
                                            ...
                                            <table class="table table-bordered mt-2">  
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><%= request.getParameter("user")%><i class="fas fa-times float-right text-red mt-2"></i></td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>  
                            ...
                            <div class="col-md-12 text-center">
                                <a href="javascript:history.back()" class="btn btn-primary text-white">Tentar novamente</a>
                            </div>
                        </div>
                    </div>
                </div>
