                    ...
                    <div class="carousel-inner questions">
                        <div class="carousel-item active">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <h5 class="card-title">Questão do Labirinto</h5>
                                    <p class="card-text">Aqui é a descrição, se você clicar pode aparecer a tabela de i/o, mas tente responder. Isto é um teste. É apenas um texto qualquer. Descrição, descrição, descrição.</p>
                        ...
                        <div class="carousel-item questions">
                            <div class="card">
                                <img class="card-img" src="img/binary.jpg" alt="Imagem de capa do card">
                                <div class="card-body">
                                    <h5 class="card-title">Título da questão</h5>
                                    <p class="card-text">Aqui é a descrição, se você clicar pode aparecer a tabela de i/o, mas tente responder. Isto é um teste. É apenas um texto qualquer. Descrição, descrição, descrição.</p>
                                    <a href="#" class="btn btn-primary">Submeter resposta</a>
                                </div>
                            </div>
                ...
                <div class="card tab-card">
                    <div class="card-header tab-card-header">
                        <ul class="nav nav-tabs card-header-tabs" id="myTab" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" id="two-tab" data-toggle="tab" href="#two" role="tab" aria-controls="Two" aria-selected="false">Colocações</a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane card-body fade show active" id="one" role="tabpanel" aria-labelledby="one-tab">
                            <img src="img/maratona3_2018.png" class="card-img imgMaratona" alt="Alunos do terceiro ano do curso técnico de informática 2018">
                            <h5 class="card-title"><b>Maratona de Informática do IFAM</b></h5>
                            <p class="card-text">Ocorre no mês de março com alunos do 1, 2 e 3 ano do curso técnico integrado em informática do IFAM.</p>
                            <a href="" class="btn btn-primary"><i class="fas fa-history fa"></i>Veja o Histórico</a>
                        ...
                        <div class="tab-pane card-body fade" id="two" role="tabpanel" aria-labelledby="two-tab">
                            ...
                            <img src="img/maratona2_2018 medals.png" class="card-img imgMaratona" alt="Alunos do terceiro ano do curso técnico de informática 2018">
                            <h5 class="card-title"><b>Premiados</b></h5>
                            <p class="card-text">Os que mais pontuaram recebem medalhas na Semana de Informática que ocorre em setembro na própria instituição. </p>
